...
<div class="parent">
  <div class='d-flex justify-content-center mainVideo'>
    ...
    <div class='d-flex grow-1 m-2'>
      <div id="genre_tag"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-tags-fill" viewBox="0 0 16 16">
  <path d="M2 2a1 1 0 0 1 1-1h4.586a1 1 0 0 1 .707.293l7 7a1 1 0 0 1 0 1.414l-4.586 4.586a1 1 0 0 1-1.414 0l-7-7A1 1 0 0 1 2 6.586V2zm3.5 4a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3z"/>
  <path d="M1.293 7.793A1 1 0 0 1 1 7.086V2a1 1 0 0 0-1 1v4.586a1 1 0 0 0 .293.707l7 7a1 1 0 0 0 1.414 0l.043-.043-7.457-7.457z"/>
</svg><p class="mini-font h6"> Genres :</p></div>
...
</svg><div class="me-3">{{ movie.vote_avg}}</div>
      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-star-fill me-1" viewBox="0 0 16 16">
  <path d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z"/>
</svg><div class="me-2" id="user_rank">{{ movie.reviews_rank_avg }}</div>
    </div>
<!--  -->
      <div class="m-2 ">
<div class="d-flex my-5">
  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-calendar4-week me-" viewBox="0 0 16 16">
  <path d="M3.5 0a.5.5 0 0 1 .5.5V1h8V.5a.5.5 0 0 1 1 0V1h1a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V3a2 2 0 0 1 2-2h1V.5a.5.5 0 0 1 .5-.5zM2 2a1 1 0 0 0-1 1v1h14V3a1 1 0 0 0-1-1H2zm13 3H1v9a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V5z"/>
  <path d="M11 7.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.5-.5v-1zm-3 0a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.5-.5v-1zm-2 3a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.5-.5v-1zm-3 0a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.5-.5v-1z"/>
</svg>
<strong><h5 class="mini-font">{{ movie.release_date }}</h5></strong>
</div>
</div>
<!--  -->
    <div class="m-2">
...
<div class="d-flex">
<strong><p class="medium-font">{{ movie.director }}</p></strong>
</div>
</div>
</div>
<!--  -->
    ...
    <div class="medium-font">
      Likeit:
      <button @click="favoriteMovie(moviePk)">{{ favoriteCount }}</button>
    </div>
 ...
 <v-row id="group">
    ...
    >
      ...
      >
        ...
        <v-btn @click="overviewPick" value="overview">
          overview
        </v-btn>

        <v-btn @click="actorPick" value="actor">
          actor
        </v-btn>

        <v-btn @click="reviewPick" value="review">
          review & rate
        </v-btn>
      </v-btn-toggle>
    </v-col>
...
<div class="container" v-show="actorCheck">
  <div class="row justify-content-center">
    <div class="card p-2 col-3 bg-black" v-for="(actor, idx) in movie.actors" :key="idx">
      <router-link class="actor-link"
        :to="{ name: 'actorProfile', params: { actorPk: actor.id } }"
      >
  <div class="card col bg-black" style="width: 18rem;">
      <img :src="tmdbUrl + actor.img_key" class="card-img-top" alt="">
      <div class="card-body">
...
export default {
  ...
  // }
  methods: {
    ...mapActions(["fetchMovie", "favoriteMovie"]),
