        ...
        <div>
          <div class="grow-1 col">
            ...
            <div class="d-flex grow-1 m-2">
              ...
              <div class="mx-1 align-middle" v-for="genre in movie.genres" :key="genre.name" >
                <p class="genres mini-font align-middle">{{ genre.name }},</p>
              </div>
            </div>
    ...
    <div class="my-3">
      <v-row id="group">
        <v-col cols="12" class="py-2">
          <v-btn-toggle dark v-model="text" tile color="deep-purple accent-2" group>
